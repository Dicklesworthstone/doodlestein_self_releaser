...
This project does not use semantic versioning tags or GitHub Releases. It ships as a single `dsr` bash script (8 000+ lines) with 26 source modules under `src/`. Development history is recorded entirely through commits on the `main` branch.

Commit links point to: `https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/<hash>`

---

## 2026-03-12 — Curl|Bash Self-Installer

Added a standalone `install.sh` that users can pipe from `curl` to install dsr itself, with SHA256 checksum verification.
...
Updated the project license to MIT with OpenAI/Anthropic Rider and added a GitHub social preview image.
...
## 2026-02-18 — Remote Build Enhancements

### Added

- Auto-generate `SHA256SUMS` and sync sibling crates for remote builds ([409bd5b](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/409bd5b252fbfd9706402a8274c0a7d7843201bc))

---

## 2026-02-03 / 2026-02-04 — Build Stabilization and Multi-Binary Support

Focused on making act-based builds and release uploads reliable, especially for multi-binary Rust workspace projects.

### Added

- Workspace binaries support for multi-binary Rust projects in act runner ([028c75b](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/028c75b5934130643126a446397f249baa7cd728))
...
- Three bugs in artifact handling and env var parsing ([18ef701](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/18ef701bd404423216c30d82831fe82cbc87eae6))
...
## 2026-02-02 — Artifact Naming, Portability, and Release Hardening

Major push on GH Actions parity: dual-name assets, portable sed/grep, and hardened release uploads.
...
- Comprehensive artifact naming test suites: install script parsing, workflow YAML parsing, dual-name generation, naming validation ([2e03b26](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/2e03b2605f72d232b282783e0d712ead8af81c34), [f14258b](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/f14258b6b2d2a7db92398de0fddc45961f3e96dd), [7920c28](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7920c28d6c844e8d52efa4cc833ca14088f82b03), [34d07df](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/34d07dfc54600b56c96bc17ed2965c530766a093))
...
- Release artifact extraction and naming ([17e40be](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/17e40be17fa6a658ccdf2c463101b46a3483fb0a))
...
- Hardened timeouts and path handling ([3b412a3](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/3b412a3ef3bac09238f4af21e719deaa37bf0833))

---

## 2026-02-01 — Artifact Naming Epic and Watch Auto-Fallback

Introduced the `src/artifact_naming.sh` module for GH Actions parity (dual naming conventions) and wired up `watch --auto-fallback`.
...
- Correct 3 bugs in watch auto-fallback implementation ([16b7fcd](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/16b7fcde49d26359767dd76ea12ae6d71be2f637))
...
Systematic JSON injection audit across all modules, act UID mismatch prevention, build matrix filtering flags, and native build support over SSH.

### Security — JSON Injection Audit

Replaced unsafe heredoc JSON construction with `jq` across the entire codebase:
...
- Prevent UID mismatch when catthehacker act images create files — `--container-options --user=UID:GID` in `~/.actrc` ([dc70487](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/dc704879ef444890337d1e42becbf5df9a4e77b9), [30f8559](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/30f85597ed338344bfa6a606ee33b90179a4c7e7))
...
## 2026-01-30 — Initial Development (Project Genesis)

The entire project was built in a single day (163 commits) using heavily parallelized multi-agent development. Every core command, all 26 source modules, the full test suite, documentation, and supply-chain security tooling were created from scratch.

### CLI Commands Implemented

| Command | Description | Key Commit |
|---------|-------------|------------|
| `dsr check` | Detect throttled GitHub Actions runs | [ecc5092](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/ecc5092df70c01b67c93340f1df0b76d82de3f35) |
| `dsr build` | Build artifacts locally via act / SSH | [024e555](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/024e555b6c73b42de18ea79643012bf291f0cecb) |
| `dsr release` | Upload artifacts to GitHub Releases | [bb2a29e](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/bb2a29eae9037b76c15cec309549f5e70c1f04fd) |
| `dsr fallback` | Full pipeline: check, build, release | [03be265](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/03be2652b9091a0ec2290921f4072c74b454dabf) |
| `dsr watch` | Continuous monitoring daemon | [d64e9fd](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/d64e9fd145d5212b40db872d9e9849d483bfa71b) |
| `dsr repos` | Manage repository registry | [7e1ca6c](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7e1ca6c0a78d31171ff7158111717dc745900b0d) |
| `dsr config` | View/modify configuration | [7c31bd2](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7c31bd2a02473fde0bc6f2441a9e1e193dfe72e4) |
| `dsr doctor` | System diagnostics | [23aaf6f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/23aaf6f83573dd7c151f40f9dc558b0ae7171f46) |
| `dsr status` | System and last-run summary | [2ceebdd](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/2ceebdd1e637bf17aa08a3cd251e54b940d587cd) |
| `dsr signing` | Manage minisign keys and signing | [6ee4e0f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/6ee4e0f4af9ac5cf84a020dcb282e0ba47408617) |
| `dsr quality` | Pre-release quality gates | [5f6ce9f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/5f6ce9f8f91cd7cb4dc10f9cede035e8c8ab4667) |
| `dsr health` | Check health of build hosts | [830f09f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/830f09f0c581cff0f479dfee83de7d7660cd6d7c) |
| `dsr release verify` | Verify release upload integrity | [9c1d8b8](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/9c1d8b8fa20e31799aa66b0c95870cc5ce3dded9) |
| `dsr release formulas` | Release formula dispatch | [e65858b](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/e65858bbc6878762aec609cc827b9506d885a95e) |

### Source Modules Created (`src/`)

| Module | Purpose | Key Commit |
|--------|---------|------------|
| `act_runner.sh` | Run GitHub Actions workflows locally via nektos/act | [25d8d4d](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/25d8d4df9f26e48c327604413cdbde4f46a0b05f) |
| `build_state.sh` | Build workspace isolation, lock files, state tracking | [f19e114](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/f19e114515605ac6bb7a838bb8ae266cd03432d7) |
| `canary.sh` | Installer canary testing in Docker | [72737e6](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/72737e6f21c91fb3c1703dea8a50244a6335e8c9) |
| `checksum_sync.sh` | Checksum auto-sync module | [528c9ac](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/528c9aca9f8fd1ab2d86e0e1847364ea751bac54) |
| `config.sh` | Configuration management and YAML parsing | [7c31bd2](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7c31bd2a02473fde0bc6f2441a9e1e193dfe72e4) |
| `dispatch.sh` | Repository dispatch for cross-repo coordination | [7b0e7c7](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7b0e7c716dc4e5bd8c07a83b2b1725eaf6316db2) |
| `docker.sh` | Docker buildx module for multi-arch container builds | [12c1fe2](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/12c1fe23f71c97f3ee4f3b409e7a241f57bae60b) |
| `git_ops.sh` | Git operations with validation helpers | [119b0da](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/119b0da760694d8f377ac77143e06b953ede9413) |
| `github.sh` | GitHub API adapter with caching | [a887269](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/a88726943164f3539a0db3b3280e07e8f44b835e) |
| `guardrails.sh` | Runtime safety guardrails (Bash 4.0+ enforcement, input validation) | [a426083](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/a42608368c63516488c1459be0ac1efcc1b76fd8) |
| `host_health.sh` | Host health checking with yq fallback | [830f09f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/830f09f0c581cff0f479dfee83de7d7660cd6d7c) |
| `host_selector.sh` | Host selection with concurrency limits | [a03d465](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/a03d46558a9d2b7c7c359d545036621ba3f64b01) |
| `install_gen.sh` | Install script generator for per-tool curl|bash installers | [37bb6b4](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/37bb6b4b8fa89a123b994e71b30292419fce3570) |
| `logging.sh` | Structured logging infrastructure | [740b8d9](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/740b8d9db2acbaf7b8b4e8c321d72c08b9a179d8) |
| `notify.sh` | Notification system for release pipeline events | [447af6d](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/447af6dadc95497176419d097745a714fe9b742c) |
| `quality_gates.sh` | Pre-release quality gates | [5f6ce9f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/5f6ce9f8f91cd7cb4dc10f9cede035e8c8ab4667) |
| `release_formulas.sh` | Release formula subcommand dispatch | [e65858b](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/e65858bbc6878762aec609cc827b9506d885a95e) |
| `sbom.sh` | SBOM generation via syft (SPDX-JSON) | [faf7934](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/faf7934920ac99f7cb1475f0915c32eff16dd803) |
| `secrets.sh` | Secrets and credential loading | [0b839d8](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/0b839d831b42f29a9adc32ae79400645a8bdd283) |
| `signing.sh` | Minisign key management | [6ee4e0f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/6ee4e0f4af9ac5cf84a020dcb282e0ba47408617) |
| `slsa.sh` | SLSA provenance attestation | [25083e3](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/25083e3b2e0ce0f61d6e0d81de0416be43834f9d) |
| `toolchain_detect.sh` | Cross-platform toolchain detection (Rust, Go, Bun) | [65ed169](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/65ed169b41ae1d50efd88d542894f6ffaf7a9d2c) |
| `upgrade_verify.sh` | Upgrade command verification after release | [29ae2c6](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/29ae2c678706fcc5437de1e4df6702b0ac8c5384) |
| `version.sh` | Version detection (Cargo.toml, go.mod, package.json, VERSION files) | [bb5c8cc](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/bb5c8cc6d7af2e17a925ea379d8aa13520e51e2c) |
...
- SBOM generation via syft ([faf7934](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/faf7934920ac99f7cb1475f0915c32eff16dd803))
- Minisign signing ([6ee4e0f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/6ee4e0f4af9ac5cf84a020dcb282e0ba47408617))
...
- Checksum auto-sync ([528c9ac](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/528c9aca9f8fd1ab2d86e0e1847364ea751bac54))
...
- AI coding agent skill auto-installation to curl installer ([ef95c5d](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/ef95c5d2068e4085a217a0d1185e048ad5b5b482))
...
- Build workspace isolation with lock/state management ([f19e114](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/f19e114515605ac6bb7a838bb8ae266cd03432d7))
- Host selection with concurrency limits ([a03d465](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/a03d46558a9d2b7c7c359d545036621ba3f64b01))
...
- Real-behavior test harness with skip protocol, time/random mocking ([7da456f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/7da456f940614c1ec87ef228d56ab6474a4eb583), [650393d](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/650393d7749a87d07db813ae416e401fa215dc9d))
...
- Unit tests: `config.sh` ([160925e](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/160925e1136a05fc7b5b3ba9b9a66a717fdaf38e)), `github.sh` ([3d4d42a](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/3d4d42a81daa58cab287822d29c23e583c95a701)), `version.sh` ([86ffd70](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/86ffd70bd0b585e2400f1170d4eab2fdf940f2ee)), `act_runner.sh` ([f5569d6](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/f5569d6bc632588c2660c2c615890e5d6abb40ed))
- E2E tests: `doctor` ([bae35a2](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/bae35a2388b0cbf778f4437d9650ed158547f82d)), `repos` ([8f0e6a1](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/8f0e6a1abfee07f1e5fef1130d91afdefcc84a04)), `status` ([595b524](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/595b524f9bcbe11048f1ead348bc7ded86a9528c)), `signing` ([aa148e0](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/aa148e0cd01cf9099d613bd3feabdcc1a6535b77)), `quality` ([2c64d71](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/2c64d718b1465640056b96660556c63434eb9587)), `watch` ([3e13b85](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/3e13b856bc560e4be199644c5500008be6518a7a)), `fallback` ([cc28bc0](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/cc28bc07e9c284482e11f5bc3389c8abb3246b95)), `health` ([43bac01](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/43bac0142d8b5e1f5c2c80402698f1df4f235d7b)), `help/version` ([11c504f](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/11c504f6db07b9d5a62ca42d86931da282f7d252))
...
- Comprehensive README ([ced193e](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/ced193eb500b41b6bd77d7091ed840692b0a4d08))
...
- SKILL.md for Claude Code agent integration ([ef95c5d](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/ef95c5d2068e4085a217a0d1185e048ad5b5b482))
...
- CLI contract JSON schemas for all commands (`schemas/`) ([f83b414](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/f83b41404468f9d4bcf9e1caa6084efde146163d))

### Notable Fixes on Day 1
...
- Multiple bugs in release command ([88872733](https://github.com/Dicklesworthstone/doodlestein_self_releaser/commit/88872733a7e9eebace87b722acb9824749839c70))
