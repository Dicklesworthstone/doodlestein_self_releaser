...
Installers generated by dsr can verify SHA256 checksums and minisign signatures
when available. Use `dsr signing init` to generate signing keys. Strict release
